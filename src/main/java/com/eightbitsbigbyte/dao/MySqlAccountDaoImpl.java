...
public class MySqlAccountDaoImpl implements AccountDao {
    ...
    public Collection<Account> getAllAccounts() {
        ...
        final String sql = "SELECT id, accountType, balance, interestRate, overdraftPenalty, requiredMB FROM account";
    ...
    public Account getAccountById(int id) {
        ...
        final String sql = "SELECT id, accountType, balance, interestRate, overdraftPenalty, requiredMB FROM account where id = ?";
    ...
    public void insertAccountToDb(Account account) {
        ...
        final String sql = "INSERT INTO account (accountType, balance, interestRate, overdraftPenalty, requiredMB) VALUES (?, ?, ?, ?, ?)";
        final String accountType = account.getAccountType();
        final long balance = account.getBalance();
        final double interestRate = account.getInterestRate();
        final long overdraftPenalty = account.getOverdraftPenalty();
        final long requiredMB = account.getRequiredMB();
        jdbcTemplate.update(sql, new Object[]{accountType, balance, interestRate, overdraftPenalty, requiredMB});
